...
<html>
    ...
    <body class="bootstrap-admin-with-small-navbar">
        ...
        <div class="container">
            <div class="row">
                <center><h1>Consulta Categoria</h1></center>
            </div>
            <div class="row" style="float: right">
                <div class="col-lg-12 form-group"> 
                    <a href="cadastrar.php"> 
                        <button id="btn_cadastrar" name="btn_cadastrar" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Cadastrar Categoria</button>
                    </a>
                </div>
            </div>
   		    <div class="row">
